    ...
    data: () => ({
        ...
        menu: [
            ...
            },
            {
                ...
                items: [
                    { title: 'Historia', enlace:{name: 'historia'}, icon:"mdi-account-outline" },
                    { title: 'Ubicacion', enlace:{name: 'ubicacion'}, icon:"mdi-city" },
                    { title: 'Turismo', enlace:{name: 'turismo'}, icon:"mdi-library" },
                    { title: 'Escudo', enlace:{name: 'cabildoMpal'}, icon:"mdi-account-box" },
                    { title: 'Fiestas y Ferias', enlace:{name: 'organigrama'}, icon:"mdi-city" },
